...
%% SECTION 1 - Iperbole di Fuga
%%% orbita finale geocentrica %%%
...
%%% orbita eliocentrica (da scenario 2) %%%
...
% Matrice di rotazione da SDR eclittico a ECI
...
for i = 1:N_r_1 
    ...
    % raggio di pericentro iperbole i-esima
    r_p_h_i = a_h*(1 - x_i(1));
...
%%% CONTROLLO DI COERENZA DELL'IPERBOLE %%%
if e_H_opt > 1 && a_h < 0
...
%%% PLOT DEL SISTEMA GEOCENTRICO 3D %%%
...
% =========================================================================
% Plot DV vs Raggio per orbite circolari
...
% Plot 3D (Surface) DV vs Eccentricità e Semiasse per orbite ellittiche
...
% Plot 2D DV vs Semiasse a parità di Eccentricità Ottima
