...
% raggio e velocità di pericentro
r_op = a_op * (1 - e_op);
...
% SOI terra (usando la distanza reale alla partenza!!)
...
if e_H1 > 1 && a_H1 < 0
    ...
    warning('I parametri calcolati non corrispondono a un''iperbole!');
end

%%% PLOT SISTEMA GEOCENTRICO 3D %%%
