function r_ijk = getPosAnim(a, e, i, OM, om, th, mu)
    ...
    % funzione per posizione 3D in animazione in codice circolarizzazione,
    % nuovamente magari si può mergare con le altre di circolarizzazione e
    % circolarizz a 1 impulso
