    ...
    for idx_p = 1:length(r_p_test_vec)
        ...
        if dV_tot < min_costo
            ...
            opt = struct('a_park', a_park, 'e_park', e_park, 'costo', dV_tot, 'tof', tempo_tot, ...
                         ...
                         'dt_coast_periarg', dt_coast_periarg, 'dt_coast_park2', dt_coast_park2, ...
                         'dt2A', dt2A, 'dt_coast_finale', dt_coast_finale);
        end
    end
end
...
% =========================================================================
% --- 4. GRAFICA AVANZATA 3D (Ordine Cronologico) ---
% =========================================================================
...
th_vec_t2   = linspace(pi, 2*pi, 150);
...
% 1. Orbita Iniziale
plot3(arrayfun(@(th) get_c(a_i,e_i,i_i,OM_i,om_i,th,1), th_vec_full), arrayfun(@(th) get_c(a_i,e_i,i_i,OM_i,om_i,th,2), th_vec_full), arrayfun(@(th) get_c(a_i,e_i,i_i,OM_i,om_i,th,3), th_vec_full), 'Color', [0 0.4470 0.7410], 'LineWidth', 2, 'DisplayName', 'Orbita Iniziale');
